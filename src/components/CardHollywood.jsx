import { getMovieByGenreHollywood } from "@/services/movie.service";
import Link from "next/link";
import { TbMathGreater } from "react-icons/tb";
import React from "react";

const CardHollywood = async () => {
  const movies = await getMovieByGenreHollywood();
  console.log(movies);
    ...
    <div className="">
      <div className="px-10   no-scrollbar">
        <span className="flex text-white py-4  text-xl">
          Hollywood movies <TbMathGreater className="m-1 ml-2" />
        </span>
