import {  getMovieByGenreAnimie } from "@/services/movie.service";
import Link from "next/link";
import { TbMathGreater } from "react-icons/tb";
import React from 'react'

const CardAnimie= async () => {
  const movies = await getMovieByGenreAnimie(); 

  return (
    <div className="">
    <div className="px-10   no-scrollbar" >
      <span className="flex text-white py-4  text-xl">
        Animie movies <TbMathGreater className="m-1 ml-2" />
      </span>
